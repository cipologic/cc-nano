...
from .types import NPC, Location, Monster
...
def _npc(
    ...
    gift_chance: float = 0.30,
    ignore_chance: float = 0.30,
    secret_chance: float = 0.40,
) -> NPC:
    # secrets 是 WORLD_SECRETS 中的索引
    ...
    gifts=[
        {
            ...
            "rarity": "common",
            "effect": "HP+10",
            "description": "闻起来有点奇怪但很有营养",
        },
        {
            "name": "幸运蘑菇",
            "rarity": "uncommon",
            "effect": "LCK+2",
            "description": "四叶草形状的稀有蘑菇",
        },
    ],
    secrets=[0, 2],
    gift_chance=0.50,
    ...
    gifts=[
        {
            ...
            "rarity": "common",
            "effect": "DEF+2",
            "description": "矮人工艺打磨的铁矿",
        },
        {
            "name": "紫水晶",
            "rarity": "uncommon",
            "effect": "ATK+2",
            "description": "蕴含能量的紫色水晶",
        },
    ],
    secrets=[3],
    gift_chance=0.40,
    ...
    gifts=[
        {
            ...
            "rarity": "uncommon",
            "effect": "HP+15",
            "description": "古代科技的修复药剂",
        },
        {
            "name": "能量芯片",
            "rarity": "rare",
            "effect": "ATK+5",
            "description": "高能量密度的古代芯片",
        },
    ],
    secrets=[6, 14],
    gift_chance=0.40,
...
def get_random_monster(region: str) -> Monster | None:
    ...
    return Monster(
        ...
        hp=_vary(template.hp),
        atk=_vary(template.atk),
        defense=_vary(template.defense),
        spd=_vary(template.spd),
